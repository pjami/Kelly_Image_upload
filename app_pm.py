...
def fill_pdf(data: Dict[str, Any]) -> bytes:
    ...
    # ── Keep PDF editable: do NOT flatten/bake form fields ──
    # This keeps text fields editable after download.
    # Note: Some mobile PDF viewers may display editable fields differently.
